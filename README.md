...
- **Communal City (Phase 1–4)** - Families, sandboxed build/run, wedge demo, live lineage graph + Austin event stream — [design](docs/COMMUNAL_CITY_DESIGN.md) · [events](docs/CITY_EVENTS.md)
