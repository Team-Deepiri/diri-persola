...
- **Communal City (Phase 1–11)** - Living agent ecosystems with generational death/legacy, memorial, Cyrex sync, Austin export — [design](docs/COMMUNAL_CITY_DESIGN.md) · [events](docs/CITY_EVENTS.md) · [scale](docs/CITY_SCALE.md) · [schema map](docs/SCHEMA_INTEGRATION_REBRAND_MAP.md)
