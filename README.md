...
- **Communal City (Phase 1–5)** - Families, build/run, live graph, Austin events, scale path to ~100 — [design](docs/COMMUNAL_CITY_DESIGN.md) · [events](docs/CITY_EVENTS.md) · [scale](docs/CITY_SCALE.md)
