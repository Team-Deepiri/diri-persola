...
- **Communal City (Phase 1–10)** - Living agent city: families, build/run, 100 personalities, pulse/heartbeat, Austin export, city conductor — [design](docs/COMMUNAL_CITY_DESIGN.md) · [events](docs/CITY_EVENTS.md) · [scale](docs/CITY_SCALE.md) · [schema map](docs/SCHEMA_INTEGRATION_REBRAND_MAP.md) (rebrand → schema impact)
