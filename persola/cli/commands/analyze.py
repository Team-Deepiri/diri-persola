...
@click.option(
    "--create", is_flag=True, default=False, help="Create a persona from the writing sample."
)
...
@click.pass_context
def analyze_command(
    ctx: click.Context, input_file: Path, create: bool, name: str | None, output_format: str
) -> None:
