...
class ConcurrencyGovernor:
	"""Fair concurrency limits: global + per-family + per-district."""
	...
	async def acquire(self, *, family_id: str, district: str = "build") -> None:
	...
	def release(self, *, family_id: str, district: str = "build") -> None:
		dk = shard_for_district(district)
